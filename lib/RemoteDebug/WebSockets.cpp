...
#include <Hash.h>
#elif defined(ESP32)
// #include <hwcrypto/sha.h> // platform.io project directive to not build sockets is not being honored an this lib can't be found. so using below. bwilly Dec17'25
#include <esp32/sha.h> 
